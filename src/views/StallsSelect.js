...
import gold1 from "assets/img/stalls/gold1.png";
import gold2 from "assets/img/stalls/gold2.png";
import gold3 from "assets/img/stalls/gold3.png";
import platinum1 from "assets/img/stalls/platinum1.png";
import platinum2 from "assets/img/stalls/platinum2.png";
import platinum3 from "assets/img/stalls/platinum3.png";
import diamond1 from "assets/img/stalls/diamond1.png";
import diamond2 from "assets/img/stalls/diamond2.png";
import diamond3 from "assets/img/stalls/diamond3.png";
        ...
        .then(async (respond) => {
          ...
          const res = await axios
            ...
            .then((res) => {
              ...
              setBookedStalls(stallIds);
              res.data.forEach((bookedStall) => {
                let divBookedStall = document.getElementById(
                  bookedStall.stallId
                );
                let stall = parseInt(bookedStall.stallId);
                if (
          ...
          <div className="container">
            ...
            <div className="container">
              ...
              <div className="container">
                ...
                <div>
                  <Payments
                    exhibitionId={localStorage.getItem("exhibitionId")}
