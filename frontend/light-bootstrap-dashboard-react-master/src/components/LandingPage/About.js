...
const About = () => {
  ...
  return (
    ...
    <p className="primary-text">Nerambum provides several advantages over physical exhibitions:</p>
    <p style={{marginRight:'8px'}}>Eliminates the need for attendees to travel, which can be time-consuming and expensive.
    Provides a more convenient experience since attendees can access the virtual exhibition from 
    anywhere with an internet connection. More environmentally friendly, as it reduces the carbon footprint associated 
    with physical events. Allows for a more inclusive experience, as attendees who may not have been able to attend 
    physical events due to mobility or other limitations can now participate in virtual exhibitions.
    Nerambum provides an engaging and immersive experience that replicates the feel of real-life exhibitions, 
    making it an attractive alternative for attendees and exhibitors alike.
    </p>
    </div>
    </div>
