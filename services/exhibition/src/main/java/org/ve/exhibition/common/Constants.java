package org.ve.exhibition.common;
import org.springframework.stereotype.Service;

@Service

public class Constants {
    public static final String FIREBASE_SDK_JSON ="/exhibition/src/main/resources/serviceAccountKey.json";//copy the sdk-config file root address, if its in root ,filename is enough
